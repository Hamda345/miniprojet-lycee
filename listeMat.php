    ...
    <div class="container">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                echo"<tbody><tr><td>".$item['id_matiere']."</td><td>".$item['nom_matiere']."</td><td>".$item['id_enseignant']."</td><td><a href='supprimerMat.php?dd=$item[0]' onClick='return confirm(\"Supprimer? \")'>Supprimer</a></td></tr></tbody>";
                }
                ?>
            </tbody>
        </table>
